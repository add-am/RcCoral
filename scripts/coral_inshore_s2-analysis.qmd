...
pacman::p_load(tidyverse, glue, here, sf, tmap, readxl, busdater)

#update/load custom package
pak::pak("add-am/RcTools")
library(RcTools)

#define the year of data to be targeted
current_fyear <- 2025
...
Next we need to create the weighting table for the Reef Check Australia data, this is explained in more detail above. It is easiest just to manually code this in.
...
Also, sometimes RCA does surveys at annoying times that don't quite line up with financial years
